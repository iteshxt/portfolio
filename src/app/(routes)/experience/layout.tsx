...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'My professional experience as a full-stack developer. Currently freelancing on modern e-commerce platforms and AI-powered applications using Next.js, Node.js, and advanced technologies.',
  path: '/experience',
  keywords: [
    "Itesh Tomar",
    "iteshxt",
