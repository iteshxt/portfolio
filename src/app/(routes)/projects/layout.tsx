...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Explore my portfolio of full-stack projects including e-commerce platforms, AI therapists, content moderation systems, and innovative web applications built with Next.js, React, and modern technologies.',
  path: '/projects',
  keywords: [
    "Itesh Tomar",
    "iteshxt",
